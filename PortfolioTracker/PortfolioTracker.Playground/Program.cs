...
var symbols = new string[] { "BTC-EUR", "ETH-EUR" };

var symbolsAsString = string.Join(",", symbols);
var result =  await httpClient.GetFromJsonAsync<Dictionary<string, AssetHistory> >("https://yfapi.net/v8/finance/spark?interval=1d&range=5y&symbols=" + symbolsAsString);
