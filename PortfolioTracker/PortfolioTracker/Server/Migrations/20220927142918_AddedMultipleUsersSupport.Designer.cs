...
namespace PortfolioTracker.Server.Migrations
{
    ...
    [Migration("20220927142918_AddedMultipleUsersSupport")]
    partial class AddedMultipleUsersSupport
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PortfolioTracker.Model.AccountBalance", b =>
                {
                    b.Property<int>("AccountBalanceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AccountBalanceId"), 1L, 1);
            ...
            modelBuilder.Entity("PortfolioTracker.Model.Asset", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdatedOn = new DateTime(2022, 9, 27, 16, 29, 17, 842, DateTimeKind.Local).AddTicks(832),
                            Value = 0m
                        },
                        new
                        {
                            ...
                            UpdatedOn = new DateTime(2022, 9, 27, 16, 29, 17, 842, DateTimeKind.Local).AddTicks(874),
                            Value = 0m
                        },
                        new
                        {
                            ...
                            UpdatedOn = new DateTime(2022, 9, 27, 16, 29, 17, 842, DateTimeKind.Local).AddTicks(878),
                            Value = 0m
                        },
                        new
                        {
                            ...
                            UpdatedOn = new DateTime(2022, 9, 27, 16, 29, 17, 842, DateTimeKind.Local).AddTicks(881),
                            Value = 0m
                        });
                });
