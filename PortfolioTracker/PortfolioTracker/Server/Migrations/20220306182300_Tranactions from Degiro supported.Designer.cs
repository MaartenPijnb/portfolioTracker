...
namespace PortfolioTracker.Server.Migrations
{
    ...
    [Migration("20220306182300_Tranactions from Degiro supported")]
    partial class TranactionsfromDegirosupported
    {
            ...
            modelBuilder.Entity("PortfolioTracker.Model.Asset", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdatedOn = new DateTime(2022, 3, 6, 19, 23, 0, 290, DateTimeKind.Local).AddTicks(4358),
                            Value = 0m
                        },
                        new
                        {
                            ...
                            UpdatedOn = new DateTime(2022, 3, 6, 19, 23, 0, 290, DateTimeKind.Local).AddTicks(4388),
                            Value = 0m
                        });
                });
